...
// checks if the ListShippingRules200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListShippingRules200Response{}

// ListShippingRules200Response struct for ListShippingRules200Response
type ListShippingRules200Response struct {
	// Page of results
	Data []ListShippingRules200ResponseDataInner `json:"data"`
...
type _ListShippingRules200Response ListShippingRules200Response
...
func NewListShippingRules200Response(data []ListShippingRules200ResponseDataInner, total float32, page float32, limit float32, totalPages float32) *ListShippingRules200Response {
	this := ListShippingRules200Response{}
	this.Data = data
	this.Total = total
	this.Page = page
	this.Limit = limit
...
func (o *ListShippingRules200Response) GetData() []ListShippingRules200ResponseDataInner {
	if o == nil {
		var ret []ListShippingRules200ResponseDataInner
		return ret
	}
...
func (o ListShippingRules200Response) MarshalJSON() ([]byte, error) {
...
func (o ListShippingRules200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListShippingRules200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListShippingRules200Response := _ListShippingRules200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListShippingRules200Response)

	if err != nil {
		return err
	}

	*o = ListShippingRules200Response(varListShippingRules200Response)

	return err
}

type NullableListShippingRules200Response struct {
	value *ListShippingRules200Response
	isSet bool
}

func (v NullableListShippingRules200Response) Get() *ListShippingRules200Response {
	return v.value
}

func (v *NullableListShippingRules200Response) Set(val *ListShippingRules200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListShippingRules200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListShippingRules200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListShippingRules200Response(val *ListShippingRules200Response) *NullableListShippingRules200Response {
	return &NullableListShippingRules200Response{value: val, isSet: true}
}

func (v NullableListShippingRules200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListShippingRules200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
