...
// checks if the ListOrderChannels200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOrderChannels200Response{}

// ListOrderChannels200Response struct for ListOrderChannels200Response
type ListOrderChannels200Response struct {
	// Page of results
	Data []ListOrderChannels200ResponseDataInner `json:"data"`
...
type _ListOrderChannels200Response ListOrderChannels200Response
...
func NewListOrderChannels200Response(data []ListOrderChannels200ResponseDataInner, total float32, page float32, limit float32, totalPages float32) *ListOrderChannels200Response {
	this := ListOrderChannels200Response{}
	this.Data = data
	this.Total = total
	this.Page = page
	this.Limit = limit
...
func (o *ListOrderChannels200Response) GetData() []ListOrderChannels200ResponseDataInner {
	if o == nil {
		var ret []ListOrderChannels200ResponseDataInner
		return ret
	}
...
func (o ListOrderChannels200Response) MarshalJSON() ([]byte, error) {
...
func (o ListOrderChannels200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ListOrderChannels200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListOrderChannels200Response := _ListOrderChannels200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListOrderChannels200Response)

	if err != nil {
		return err
	}

	*o = ListOrderChannels200Response(varListOrderChannels200Response)

	return err
}

type NullableListOrderChannels200Response struct {
	value *ListOrderChannels200Response
	isSet bool
}

func (v NullableListOrderChannels200Response) Get() *ListOrderChannels200Response {
	return v.value
}

func (v *NullableListOrderChannels200Response) Set(val *ListOrderChannels200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOrderChannels200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOrderChannels200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOrderChannels200Response(val *ListOrderChannels200Response) *NullableListOrderChannels200Response {
	return &NullableListOrderChannels200Response{value: val, isSet: true}
}

func (v NullableListOrderChannels200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOrderChannels200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
