...
// checks if the CreateOrder201ResponseOrderLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrder201ResponseOrderLinesInner{}

// CreateOrder201ResponseOrderLinesInner struct for CreateOrder201ResponseOrderLinesInner
type CreateOrder201ResponseOrderLinesInner struct {
...
type _CreateOrder201ResponseOrderLinesInner CreateOrder201ResponseOrderLinesInner
...
func NewCreateOrder201ResponseOrderLinesInner(name string, quantity int32) *CreateOrder201ResponseOrderLinesInner {
	this := CreateOrder201ResponseOrderLinesInner{}
	this.Name = name
...
func (o *CreateOrder201ResponseOrderLinesInner) SetSkuNil() {
	o.Sku.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetUnitPriceNil() {
	o.UnitPrice.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetTotalPriceNil() {
...
func (o *CreateOrder201ResponseOrderLinesInner) SetCurrencyNil() {
	o.Currency.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetWeightUnitNil() {
...
func (o *CreateOrder201ResponseOrderLinesInner) SetVariantIdNil() {
	o.VariantId.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetProductIdNil() {
	o.ProductId.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetHsCodeNil() {
	o.HsCode.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetCountryOfOriginNil() {
...
func (o *CreateOrder201ResponseOrderLinesInner) SetProvinceOfOriginNil() {
...
func (o *CreateOrder201ResponseOrderLinesInner) SetBarcodeNil() {
	o.Barcode.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetRequiresShippingNil() {
...
func (o *CreateOrder201ResponseOrderLinesInner) SetTaxableNil() {
	o.Taxable.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetGiftCardNil() {
	o.GiftCard.Set(nil)
}
...
func (o *CreateOrder201ResponseOrderLinesInner) SetVendorNil() {
	o.Vendor.Set(nil)
}
...
func (o CreateOrder201ResponseOrderLinesInner) MarshalJSON() ([]byte, error) {
...
func (o CreateOrder201ResponseOrderLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *CreateOrder201ResponseOrderLinesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrder201ResponseOrderLinesInner := _CreateOrder201ResponseOrderLinesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrder201ResponseOrderLinesInner)

	if err != nil {
		return err
	}

	*o = CreateOrder201ResponseOrderLinesInner(varCreateOrder201ResponseOrderLinesInner)

	return err
}

type NullableCreateOrder201ResponseOrderLinesInner struct {
	value *CreateOrder201ResponseOrderLinesInner
	isSet bool
}

func (v NullableCreateOrder201ResponseOrderLinesInner) Get() *CreateOrder201ResponseOrderLinesInner {
	return v.value
}

func (v *NullableCreateOrder201ResponseOrderLinesInner) Set(val *CreateOrder201ResponseOrderLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrder201ResponseOrderLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrder201ResponseOrderLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrder201ResponseOrderLinesInner(val *CreateOrder201ResponseOrderLinesInner) *NullableCreateOrder201ResponseOrderLinesInner {
	return &NullableCreateOrder201ResponseOrderLinesInner{value: val, isSet: true}
}

func (v NullableCreateOrder201ResponseOrderLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrder201ResponseOrderLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
