...
// checks if the UpdateOrgBrandRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateOrgBrandRequest{}

// UpdateOrgBrandRequest struct for UpdateOrgBrandRequest
type UpdateOrgBrandRequest struct {
...
func (o *UpdateOrgBrandRequest) SetCompanyNameNil() {
...
func (o *UpdateOrgBrandRequest) SetVatNumberNil() {
	o.VatNumber.Set(nil)
}
...
func (o *UpdateOrgBrandRequest) SetAddressLine1Nil() {
...
func (o *UpdateOrgBrandRequest) SetAddressLine2Nil() {
...
func (o *UpdateOrgBrandRequest) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *UpdateOrgBrandRequest) SetPostalCodeNil() {
...
func (o *UpdateOrgBrandRequest) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *UpdateOrgBrandRequest) SetPrimaryColorNil() {
...
func (o *UpdateOrgBrandRequest) SetSecondaryColorNil() {
...
func (o UpdateOrgBrandRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateOrgBrandRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateOrgBrandRequest struct {
	value *UpdateOrgBrandRequest
	isSet bool
}

func (v NullableUpdateOrgBrandRequest) Get() *UpdateOrgBrandRequest {
	return v.value
}

func (v *NullableUpdateOrgBrandRequest) Set(val *UpdateOrgBrandRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOrgBrandRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOrgBrandRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOrgBrandRequest(val *UpdateOrgBrandRequest) *NullableUpdateOrgBrandRequest {
	return &NullableUpdateOrgBrandRequest{value: val, isSet: true}
}

func (v NullableUpdateOrgBrandRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOrgBrandRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
