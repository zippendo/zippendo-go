...
func (r ApiListAddressesRequest) BrandId(brandId string) ApiListAddressesRequest {
	r.brandId = &brandId
	return r
}
...
func (r ApiListAddressesRequest) BrandScope(brandScope string) ApiListAddressesRequest {
