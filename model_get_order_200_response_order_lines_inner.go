...
// checks if the GetOrder200ResponseOrderLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrder200ResponseOrderLinesInner{}

// GetOrder200ResponseOrderLinesInner struct for GetOrder200ResponseOrderLinesInner
type GetOrder200ResponseOrderLinesInner struct {
...
type _GetOrder200ResponseOrderLinesInner GetOrder200ResponseOrderLinesInner
...
func NewGetOrder200ResponseOrderLinesInner(name string, quantity int32, packedQuantity int32) *GetOrder200ResponseOrderLinesInner {
	this := GetOrder200ResponseOrderLinesInner{}
	this.Name = name
...
func (o *GetOrder200ResponseOrderLinesInner) SetSkuNil() {
	o.Sku.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetUnitPriceNil() {
	o.UnitPrice.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetTotalPriceNil() {
...
func (o *GetOrder200ResponseOrderLinesInner) SetCurrencyNil() {
	o.Currency.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetWeightNil() {
	o.Weight.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetWeightUnitNil() {
...
func (o *GetOrder200ResponseOrderLinesInner) SetVariantIdNil() {
	o.VariantId.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetProductIdNil() {
	o.ProductId.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetHsCodeNil() {
	o.HsCode.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetCountryOfOriginNil() {
...
func (o *GetOrder200ResponseOrderLinesInner) SetProvinceOfOriginNil() {
...
func (o *GetOrder200ResponseOrderLinesInner) SetBarcodeNil() {
	o.Barcode.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetRequiresShippingNil() {
...
func (o *GetOrder200ResponseOrderLinesInner) SetTaxableNil() {
	o.Taxable.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetGiftCardNil() {
	o.GiftCard.Set(nil)
}
...
func (o *GetOrder200ResponseOrderLinesInner) SetVendorNil() {
	o.Vendor.Set(nil)
}
...
func (o GetOrder200ResponseOrderLinesInner) MarshalJSON() ([]byte, error) {
...
func (o GetOrder200ResponseOrderLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetOrder200ResponseOrderLinesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrder200ResponseOrderLinesInner := _GetOrder200ResponseOrderLinesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrder200ResponseOrderLinesInner)

	if err != nil {
		return err
	}

	*o = GetOrder200ResponseOrderLinesInner(varGetOrder200ResponseOrderLinesInner)

	return err
}

type NullableGetOrder200ResponseOrderLinesInner struct {
	value *GetOrder200ResponseOrderLinesInner
	isSet bool
}

func (v NullableGetOrder200ResponseOrderLinesInner) Get() *GetOrder200ResponseOrderLinesInner {
	return v.value
}

func (v *NullableGetOrder200ResponseOrderLinesInner) Set(val *GetOrder200ResponseOrderLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrder200ResponseOrderLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrder200ResponseOrderLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrder200ResponseOrderLinesInner(val *GetOrder200ResponseOrderLinesInner) *NullableGetOrder200ResponseOrderLinesInner {
	return &NullableGetOrder200ResponseOrderLinesInner{value: val, isSet: true}
}

func (v NullableGetOrder200ResponseOrderLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrder200ResponseOrderLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
