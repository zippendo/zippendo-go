...
type ListAddresses200Response struct {
	// Page of results
	Data []ListAddresses200ResponseDataInner `json:"data"`
...
func (o *ListAddresses200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListAddresses200Response := _ListAddresses200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListAddresses200Response)

	if err != nil {
		return err
	}

	*o = ListAddresses200Response(varListAddresses200Response)
